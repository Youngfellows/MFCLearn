...
BEGIN_MESSAGE_MAP(CMFCSdiApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CMFCSdiApp::OnAppAbout)
	// 基于文件的标准文档命令
...
CMFCSdiApp::CMFCSdiApp() noexcept
{
	...
	SetAppID(_T("MFCSdi.AppID.NoVersion"));
