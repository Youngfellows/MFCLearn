========================================================================
    STATIC LIBRARY : MFCStatic Project Overview
========================================================================

AppWizard has created this MFCStatic library project for you.

This file contains a summary of what you will find in each of the files that
make up your MFCStatic application.
...
StdAfx.h, StdAfx.cpp
    ...
    named MFCStatic.pch and a precompiled types file named StdAfx.obj.
...
project, including "resource.h", "MFCStatic.rc" and a "MFCStatic.h" that
